        ...
        <section class="contenedor__peliculas">
            ...
            <article id="p36" id="p36" class="articulos articulos--derecha primer--articulo">
                <div class="articulos__div">
                    ...
                    <p class="div__parrafo">
                        Tras tres meses de someterse a un programa de entrenamiento físico y táctico, Steve
                        Rogers es encomendado su primera misión como Capitán América. Armado con un escudo
                        indestructible, emprenderá la guerra contra el Mal como líder de los Vengadores.
                    </p>
                </div>
                <!-- carousel -->
                <div id="carouselExampleIndicators36" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy"
                                src="../Imagenes/imagenes1500/portadaspeliculas/capitanAmericaPrimerVengador.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/capitanAmericaPrimerVengador.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/capitanAmericaPrimerVengador.jpg 700w"
                                class="d-block w-100" alt="Cap america">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2011capAmerica.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2011capAmerica.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2011capAmerica.jpg 700w"
                                class="d-block w-100" alt="Cap America">
                        </div>
                    </div>
                </div>
            ...
            <article id="p37" class="articulos articulos--izquierda">
                ...
                <div id="carouselExampleIndicators37" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/advengers2012.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/advengers2012.jpg 1500w,
                                ../Imagenes/imagenes768/portadaspeliculas/advengers2012.jpg 700w" class="d-block w-100"
                                alt="Los Vengadores">
                        </div>
                        <div class="carousel-item">
            ...
            <article id="p38" class="articulos">
                <div class="articulos__div">
                    ...
                    <p class="div__parrafo">El descarado y brillante Tony Stark, tras ver destruido todo su universo
                        personal, debe encontrar y enfrentarse a un enemigo cuyo poder no conoce límites. Este viaje
                        pondrá a prueba su entereza una y otra vez, y le obligará a confiar en su ingenio.
                    </p>
                </div>
                <!-- carousel -->
                <div id="carouselExampleIndicators38" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/IronMan3.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/IronMan3.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/IronMan3.jpg 700w"
                                class="d-block w-100" alt="Iron Man 3">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2013ironman.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2013ironman.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2013ironman.jpg 700w"
                                class="d-block w-100" alt="Iron Man 3">
                        </div>
                        <div class="carousel-item">
            ...
            <article id="p40" class="articulos">
                ...
                <div id="carouselExampleIndicators40" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/capitanAmerica2014.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/capitanAmerica2014.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/capitanAmerica2014.jpg 700w"
                                class="d-block w-100" alt="Capitán América">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2014cap.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2014cap.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2014cap.jpg 700w"
                                class="d-block w-100" alt="Capitán América">
                        </div>
                    </div>
                </div>
            ...
            <article id="p41" class="articulos articulos--izquierda">
                <div class="articulos__div">
                    ...
                    <p class="div__parrafo">El temerario aventurero Peter Quill, tras robar una misteriosa esfera
                        codiciada por Ronan, un poderoso villano cuyas ambiciones amenazan a todo el universo, se
                        convierte en la presa más codiciada por todos los cazarrecompensas de la galaxia.
                    </p>
                </div>
                <!-- carousel -->
                <div id="carouselExampleIndicators41" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/gdlx2014.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/gdlx2014.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/gdlx2014.jpg 700w"
                                class="d-block w-100" alt="Guardianes de la Galaxia">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2014gdlg.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2014gdlg.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2014gdlg.jpg 700w"
                                class="d-block w-100" alt="Guardianes de la Galaxia">
                        </div>
                    </div>
                </div>
            ...
            <article id="p42" class="articulos">
                <div class="articulos__div">
                    ...
                    <p class="div__parrafo">Tony Stark quiere lanzar un nuevo programa de paz, pero algo sale mal y
                        acaba creando a Ultrón, un robot que quiere destruir a la humanidad. Thor, Hulk y el resto de
                        los Vengadores deberán juntar sus fuerzas una vez más para luchar contra el robot.
                    </p>
                </div>
                <!-- carousel -->
                <div id="carouselExampleIndicators42" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/advengers2015.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/advengers2015.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/advengers2015.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2015avengers.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2015avengers.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2015avengers.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2015avengers-1.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2015avengers-1.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2015avengers-1.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2015-2.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2015-2.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2015-2.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2015avengers-3.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2015avengers-3.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2015avengers-3.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                    </div>
                </div>
            ...
            <article id="p43" class="articulos articulos--izquierda">
                <div class="articulos__div">
                    ...
                    <p class="div__parrafo">El doctor Hank Pym anuncia que abandona S.H.I.E.L.D. tras descubrir que han
                        tratado de apropiarse de la tecnología de su Ant-Man, que Pym considera altamente peligrosa.
                        Varios años después, Scott Lang sale de prisión tras cumplir tres años de condena por robo.
                    </p>
                </div>
                <!-- carousel -->
                <div id="carouselExampleIndicators43" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#carouselExampleIndicators43" data-bs-slide-to="0"
                            class="active" aria-current="true" aria-label="Slide 1"></button>
                        <button type="button" data-bs-target="#carouselExampleIndicators43" data-bs-slide-to="1"
                            aria-label="Slide 2"></button>
                    </div>
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/civilwar.jpg"
            ...
            <article id="p45" class="articulos articulos--izquierda">
                ...
                <div id="carouselExampleIndicators45" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/drstrange.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/drstrange.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/drstrange.jpg 700w"
            ...
            <article id="p47" class="articulos articulos--izquierda">
                <div class="articulos__div">
                    ...
                    <p class="div__parrafo">Thor está preso en el otro extremo del universo. Necesita regresar a tiempo
                        para evitar que la todopoderosa Hela destruya su mundo, pero para escapar de su confinamiento y
                        evitar el apocalipsis tendrá que vencer antes al increíble Hulk en un torneo de gladiadores.
                    </p>
                </div>
                <!-- carousel -->
                <div id="carouselExampleIndicators47" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/thor2017.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/thor2017.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/thor2017.jpg 700w"
                                class="d-block w-100" alt="Thor">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2017thor.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2017thor.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2017thor.jpg 700w"
                                class="d-block w-100" alt="Thor">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/thor-1.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/thor-1.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/thor-1.jpg 700w"
                                class="d-block w-100" alt="Thor">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2017thor-2.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2017thor-2.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2017thor-2.jpg 700w"
                                class="d-block w-100" alt="Thor">
                        </div>
                    </div>
                </div>
            ...
            <article id="p51" class="articulos articulos--izquierda">
                ...
                <div id="carouselExampleIndicators51" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/antman2018.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/antman2018.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/antman2018.jpg 700w"
                                class="d-block w-100" alt="Ant-Man">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2018antman.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2018antman.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2018antman.jpg 700w"
                                class="d-block w-100" alt="Ant-Man">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2018antman-1.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2018antman-1.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2018antman-1.jpg 700w"
                                class="d-block w-100" alt="Ant-Man">
                        </div>
                    </div>
                </div>
            ...
            <article id="p53" class="articulos articulos--izquierda">
                <div class="articulos__div">
                    ...
                    <p class="div__parrafo">Después de los eventos devastadores de "Avengers: Infinity War", el
                        universo está en ruinas debido a las acciones de Thanos, el Titán Loco. Con la ayuda de los
                        aliados que quedaron, los Vengadores deberán reunirse una vez más para intentar detenerlo y
                        restaurar el orden en el universo de una vez por todas.
                    </p>
                </div>
                <!-- carousel -->
                <div id="carouselExampleIndicators53" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/endGame.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/endGame.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/endGame.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2019endgame-1.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2019endgame-1.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2019endgame-1.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2019eg-womens-1.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2019eg-womens-1.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2019eg-womens-1.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2019eg-womens-2.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2019eg-womens-2.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2019eg-womens-2.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2019egviaje.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2019egviaje.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2019egviaje.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2019eg-natasha.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2019eg-natasha.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2019eg-natasha.jpg 700w"
                                class="d-block w-100" alt="Vengadores">
                        </div>
                    </div>
                </div>
            ...
            <article id="p54" class="articulos">
                <div class="articulos__div">
                    ...
                    <p class="div__parrafo"> Peter Parker decide pasar unas merecidas vacaciones en Europa junto a MJ,
                        Ned y el resto de sus amigos. Sin embargo, Peter debe volver a ponerse el traje de Spider-Man
                        cuando Nick Fury le encomienda una nueva misión: frenar el ataque de unas criaturas que están
                        causando el caos en el continente.
                    </p>
                </div>
                <!-- carousel -->
                <div id="carouselExampleIndicators54" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy"
                                src="../Imagenes/imagenes1500/portadaspeliculas/SpdiermanLejosDeCasa.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/SpdiermanLejosDeCasa.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/SpdiermanLejosDeCasa.jpg 700w"
                                class="d-block w-100" alt="Spider-Man">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2019spiderman-1.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2019spiderman-1.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2019spiderman-1.jpg 700w"
                                class="d-block w-100" alt="Spider-Man">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2019spiderman.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2019spiderman.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2019spiderman.jpg 700w"
                                class="d-block w-100" alt="Spider-Man">
                        </div>
                    </div>
                </div>
            ...
            <article id="p62" class="articulos">
                <div class="articulos__div">
                    ...
                    <p class="div__parrafo">Tras descubrirse la identidad secreta de Peter Parker como Spider-Man, la
                        vida del joven se vuelve una locura. Peter decide pedirle ayuda al Doctor Extraño para recuperar
                        su vida. Pero algo
                ...
                <div id="carouselExampleIndicators62" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img loading="lazy" src="../Imagenes/imagenes1500/portadaspeliculas/SpidermanNoWayHome.jpg"
                                srcset="../Imagenes/imagenes1500/portadaspeliculas/SpidermanNoWayHome.jpg 1500w, ../Imagenes/imagenes768/portadaspeliculas/SpidermanNoWayHome.jpg 700w"
                                class="d-block w-100" alt="Spider-Man">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2021spiderman.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2021spiderman.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2021spiderman.jpg 700w"
                                class="d-block w-100" alt="Spider-Man">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="../Imagenes/imagenes1500/carousel-imgs/2021spidermans.jpg"
                                srcset="../Imagenes/imagenes1500/carousel-imgs/2021spidermans.jpg 1500w, ../Imagenes/imagenes768/carousel-imgs/2021spidermans.jpg 700w"
                                class="d-block w-100" alt="Spider-Man">
                        </div>
                    </div>
                </div>
